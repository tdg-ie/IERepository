...
import branch_and_bound.engine.FoilEngineWithoutPostProcessing;

public class FoilEngineWithoutPostProcessingTest {
...
//		args = new String[12];
//		args[0] = "E:/Analysis13-Opc1-Input-Output-Mode/trainingInputFilesProcessed/RISE/1-crossValidation_Zagat/address/fold1/trainingFile.pl";
//		args[1] = "";
//		args[2] = "E:/Analysis13-Opc1-Input-Output-Mode/output/RISE/1-crossValidation_Zagat/color";
//		args[3] = "address";
//		args[4] = "DEFAULTSTOPCRITERIA";
//		args[5] = "ALPHABETA_ANALYSER";
//		args[6] = "0";
//		args[7] = "INFORMATIONGAIN";
//		args[8] = "E:/Analysis13-Opc1-Input-Output-Mode/configuration.properties";
...
//		args[11] = "FOILHEURISTIC"; //FOILHEURISTIC, MAXIMUMGAIN
		...
		if (args.length > 11) {
			//deber�amos hacerlo con todos los par�metros
		...
		FoilEngineWithoutPostProcessing fE = new FoilEngineWithoutPostProcessing(outputDir);
